...
module ArmShips =
    ...
    let armrecl : Armrecl =
        { name = "armrecl"
          subfolder = "ArmShips"
          printableName = Some "Grim Reaper"
    ...
    let armtorps : Armtorps =
        { name = "armtorps"
          subfolder = "ArmShips"
          printableName = Some "Torpedo Ship"
