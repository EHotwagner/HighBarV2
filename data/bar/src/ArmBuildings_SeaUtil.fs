...
module ArmBuildings_SeaUtil =
    ...
    let armason =
        LuaValue.Table [
            ...
            LuaKey.String "buildpic", LuaValue.String "ARMASON.DDS"
            LuaKey.String "buildtime", LuaValue.Number 6150.0
            ...
            LuaKey.String "explodeas", LuaValue.String "mediumBuildingexplosiongeneric-uw"
            ...
            LuaKey.String "objectname", LuaValue.String "Units/ARMASON.s3o"
            LuaKey.String "onoffable", LuaValue.Bool false
            LuaKey.String "script", LuaValue.String "Units/ARMASON.cob"
            LuaKey.String "seismicsignature", LuaValue.Number 0.0
            LuaKey.String "selfdestructas", LuaValue.String "mediumBuildingExplosionGenericSelfd-uw"
            LuaKey.String "sightdistance", LuaValue.Number 215.0
            LuaKey.String "sonardistance", LuaValue.Number 1600.0
            ...
            LuaKey.String "customparams", LuaValue.Table [
                    ...
                    LuaKey.String "buildinggrounddecaltype", LuaValue.String "decals/armason_aoplane.dds"
            ...
            LuaKey.String "featuredefs", LuaValue.Table [
                    LuaKey.String "dead", LuaValue.Table [
                            ...
                            LuaKey.String "collisionvolumeoffsets", LuaValue.String "-2.53617095947 -6.10351563068e-07 -2.30155944824"
                            LuaKey.String "collisionvolumescales", LuaValue.String "30.2144622803 57.7799987793 23.5352478027"
                            ...
                            LuaKey.String "object", LuaValue.String "Units/armason_dead.s3o"
            ...
            LuaKey.String "sounds", LuaValue.Table [
                    ...
                    LuaKey.String "select", LuaValue.Table [
                            LuaKey.Int 1, LuaValue.String "sonar1"
                        ]
                ]
        ]
    ...
    let armfatf =
        LuaValue.Table [
            LuaKey.String "activatewhenbuilt", LuaValue.Bool true
            LuaKey.String "buildangle", LuaValue.Number 16400.0
            LuaKey.String "buildpic", LuaValue.String "ARMFATF.DDS"
            LuaKey.String "buildtime", LuaValue.Number 9880.0
            LuaKey.String "canrepeat", LuaValue.Bool false
            LuaKey.String "collisionvolumeoffsets", LuaValue.String "0 -10 0"
            LuaKey.String "collisionvolumescales", LuaValue.String "52 44 52"
            LuaKey.String "collisionvolumetype", LuaValue.String "CylY"
            LuaKey.String "corpse", LuaValue.String "DEAD"
            LuaKey.String "energycost", LuaValue.Number 7300.0
            LuaKey.String "energyupkeep", LuaValue.Number 150.0
            ...
            LuaKey.String "objectname", LuaValue.String "Units/ARMFATF.s3o"
            LuaKey.String "onoffable", LuaValue.Bool true
            LuaKey.String "script", LuaValue.String "Units/ARMFATF.cob"
            LuaKey.String "seismicsignature", LuaValue.Number 0.0
            ...
            LuaKey.String "featuredefs", LuaValue.Table [
                    LuaKey.String "dead", LuaValue.Table [
                            ...
                            LuaKey.String "category", LuaValue.String "corpses"
                            LuaKey.String "collisionvolumeoffsets", LuaValue.String "1.36531829834 -6.85653535156 1.18824005127"
                            LuaKey.String "collisionvolumescales", LuaValue.String "59.4412994385 29.0925292969 58.6490936279"
                            LuaKey.String "collisionvolumetype", LuaValue.String "Box"
                            LuaKey.String "damage", LuaValue.Number 871.0
                            LuaKey.String "featuredead", LuaValue.String "HEAP"
                            LuaKey.String "footprintx", LuaValue.Number 4.0
                            LuaKey.String "footprintz", LuaValue.Number 4.0
                            LuaKey.String "height", LuaValue.Number 20.0
                            LuaKey.String "metal", LuaValue.Number 467.0
                            LuaKey.String "object", LuaValue.String "Units/armfatf_dead.s3o"
                            LuaKey.String "reclaimable", LuaValue.Bool true
                        ]
                    LuaKey.String "heap", LuaValue.Table [
                            ...
                            LuaKey.String "collisionvolumetype", LuaValue.String "cylY"
                            LuaKey.String "damage", LuaValue.Number 436.0
                            LuaKey.String "footprintx", LuaValue.Number 4.0
                            LuaKey.String "footprintz", LuaValue.Number 4.0
    ...
    let armfdrag =
        LuaValue.Table [
            LuaKey.String "blocking", LuaValue.Bool true
            LuaKey.String "buildangle", LuaValue.Number 8192.0
            LuaKey.String "buildpic", LuaValue.String "ARMFDRAG.DDS"
            LuaKey.String "buildtime", LuaValue.Number 370.0
            LuaKey.String "canattack", LuaValue.Bool false
            LuaKey.String "canrepeat", LuaValue.Bool false
            ...
            LuaKey.String "objectname", LuaValue.String "Units/ARMFDRAG.s3o"
            LuaKey.String "repairable", LuaValue.Bool false
            LuaKey.String "script", LuaValue.String "Units/ARMFDRAG.cob"
            LuaKey.String "seismicsignature", LuaValue.Number 0.0
    ...
    let armfgate =
        LuaValue.Table [
            ...
            LuaKey.String "builder", LuaValue.Number 0.0
            LuaKey.String "buildpic", LuaValue.String "ARMFGATE.DDS"
            LuaKey.String "onoffable", LuaValue.Bool true
            ...
            LuaKey.String "collisionvolumescales", LuaValue.String "53 65 53"
            LuaKey.String "collisionvolumetype", LuaValue.String "cyly"
            LuaKey.String "corpse", LuaValue.String "DEAD"
            ...
            LuaKey.String "maxdec", LuaValue.Number 0.0
            LuaKey.String "maxslope", LuaValue.Number 10.0
            LuaKey.String "metalcost", LuaValue.Number 3900.0
            LuaKey.String "minwaterdepth", LuaValue.Number 16.0
            LuaKey.String "noautofire", LuaValue.Bool true
            LuaKey.String "norestrict", LuaValue.Number 1.0
            LuaKey.String "objectname", LuaValue.String "Units/armfgate.s3o"
            LuaKey.String "script", LuaValue.String "Units/armfgate.cob"
            LuaKey.String "seismicsignature", LuaValue.Number 0.0
            ...
            LuaKey.String "unitname", LuaValue.String "armfgate"
            ...
            LuaKey.String "customparams", LuaValue.Table [
                    ...
                    LuaKey.String "shield_power", LuaValue.Number 9500.0
                    LuaKey.String "shield_radius", LuaValue.Number 600.0
                    LuaKey.String "subfolder", LuaValue.String "ArmBuildings/SeaUtil"
                    LuaKey.String "techlevel", LuaValue.Number 2.0
                    LuaKey.String "unitgroup", LuaValue.String "util"
                ]
            LuaKey.String "featuredefs", LuaValue.Table [
                    LuaKey.String "dead", LuaValue.Table [
                            ...
                            LuaKey.String "footprintz", LuaValue.Number 2.0
                            LuaKey.String "height", LuaValue.Number 20.0
                            LuaKey.String "metal", LuaValue.Number 2296.0
                            LuaKey.String "object", LuaValue.String "Units/armfgate_dead.s3o"
                            LuaKey.String "reclaimable", LuaValue.Bool true
                        ]
                    LuaKey.String "heap", LuaValue.Table [
                            LuaKey.String "blocking", LuaValue.Bool false
                            ...
                            LuaKey.String "footprintz", LuaValue.Number 2.0
                            LuaKey.String "height", LuaValue.Number 4.0
                            LuaKey.String "metal", LuaValue.Number 918.0
            ...
            LuaKey.String "weapondefs", LuaValue.Table [
                    LuaKey.String "sea_repulsor", LuaValue.Table [
                            ...
                            LuaKey.String "name", LuaValue.String "NavalPlasmaRepulsor"
                            ...
                            LuaKey.String "shield", LuaValue.Table [
                                    ...
                                    LuaKey.String "radius", LuaValue.Number 600.0
            ...
            LuaKey.String "weapons", LuaValue.Table [
                    LuaKey.Int 1, LuaValue.Table [
                            LuaKey.String "def", LuaValue.String "SEA_REPULSOR"
    ...
    let armfmine3 =
        LuaValue.Table [
            LuaKey.String "blocking", LuaValue.Bool false
            LuaKey.String "buildpic", LuaValue.String "ARMFMINE3.DDS"
            ...
            LuaKey.String "canrepeat", LuaValue.Bool false
            LuaKey.String "cloakcost", LuaValue.Number 4.0
            LuaKey.String "collide", LuaValue.Bool false
            LuaKey.String "collisionvolumeoffsets", LuaValue.String "0 -1.5 0"
            LuaKey.String "collisionvolumescales", LuaValue.String "18 5 18"
            LuaKey.String "collisionvolumetype", LuaValue.String "CylY"
            LuaKey.String "energycost", LuaValue.Number 1600.0
            LuaKey.String "explodeas", LuaValue.String "FMINE_HEAVY"
            ...
            LuaKey.String "minwaterdepth", LuaValue.Number 0.0
            LuaKey.String "nochasecategory", LuaValue.String "VTOL"
            LuaKey.String "objectname", LuaValue.String "Units/ARMFMINE3.s3o"
            LuaKey.String "script", LuaValue.String "mines_lus.lua"
            LuaKey.String "seismicsignature", LuaValue.Number 0.0
            LuaKey.String "selfdestructas", LuaValue.String "FMINE_HEAVY"
            LuaKey.String "selfdestructcountdown", LuaValue.Number 0.0
            LuaKey.String "sightdistance", LuaValue.Number 78.0
            ...
            LuaKey.String "yardmap", LuaValue.String "w"
            LuaKey.String "customparams", LuaValue.Table [
    ...
    let armfrad =
        LuaValue.Table [
            ...
            LuaKey.String "buildpic", LuaValue.String "ARMFRAD.DDS"
            ...
            LuaKey.String "objectname", LuaValue.String "Units/ARMFRAD.s3o"
            LuaKey.String "onoffable", LuaValue.Bool false
            LuaKey.String "radardistance", LuaValue.Number 2100.0
            LuaKey.String "radaremitheight", LuaValue.Number 52.0
            LuaKey.String "script", LuaValue.String "Units/ARMFRAD.cob"
            LuaKey.String "seismicsignature", LuaValue.Number 0.0
            ...
            LuaKey.String "featuredefs", LuaValue.Table [
                    LuaKey.String "dead", LuaValue.Table [
                            ...
                            LuaKey.String "object", LuaValue.String "Units/armfrad_dead.s3o"
                            LuaKey.String "reclaimable", LuaValue.Bool true
                        ]
                ]
    ...
    let armnanotc2plat =
        LuaValue.Table [
            ...
            LuaKey.String "buildpic", LuaValue.String "armnanotc2plat.DDS"
            ...
            LuaKey.String "objectname", LuaValue.String "Units/armnanotc2plat.s3o"
            LuaKey.String "script", LuaValue.String "Units/armnanotc2plat.cob"
            LuaKey.String "seismicsignature", LuaValue.Number 0.0
    ...
    let armnanotcplat =
        LuaValue.Table [
            ...
            LuaKey.String "minwaterdepth", LuaValue.Number 12.0
            LuaKey.String "movementclass", LuaValue.String "NANO"
            LuaKey.String "objectname", LuaValue.String "Units/ARMNANOTCPLAT.s3o"
            LuaKey.String "script", LuaValue.String "Units/ARMNANOTCPLAT.cob"
            LuaKey.String "seismicsignature", LuaValue.Number 0.0
            LuaKey.String "selfdestructas", LuaValue.String "nanoselfd"
    ...
    let armsonar =
        LuaValue.Table [
            LuaKey.String "activatewhenbuilt", LuaValue.Bool true
            LuaKey.String "buildangle", LuaValue.Number 8192.0
            LuaKey.String "buildpic", LuaValue.String "ARMSONAR.DDS"
            LuaKey.String "buildtime", LuaValue.Number 910.0
            LuaKey.String "canattack", LuaValue.Bool false
            LuaKey.String "canrepeat", LuaValue.Bool false
            LuaKey.String "collisionvolumeoffsets", LuaValue.String "0 0 0"
            LuaKey.String "collisionvolumescales", LuaValue.String "28 41 28"
            LuaKey.String "collisionvolumetype", LuaValue.String "CylY"
            LuaKey.String "corpse", LuaValue.String "DEAD"
            LuaKey.String "energycost", LuaValue.Number 450.0
            LuaKey.String "explodeas", LuaValue.String "smallBuildingexplosiongeneric-uw"
            LuaKey.String "footprintx", LuaValue.Number 2.0
            LuaKey.String "footprintz", LuaValue.Number 2.0
            LuaKey.String "health", LuaValue.Number 56.0
            LuaKey.String "maxacc", LuaValue.Number 0.0
            LuaKey.String "maxdec", LuaValue.Number 0.0
            LuaKey.String "maxslope", LuaValue.Number 10.0
            LuaKey.String "metalcost", LuaValue.Number 20.0
            LuaKey.String "minwaterdepth", LuaValue.Number 10.0
            LuaKey.String "objectname", LuaValue.String "Units/ARMSONAR.s3o"
            LuaKey.String "onoffable", LuaValue.Bool false
            LuaKey.String "script", LuaValue.String "Units/ARMSONAR.cob"
            LuaKey.String "seismicsignature", LuaValue.Number 0.0
            LuaKey.String "selfdestructas", LuaValue.String "smallBuildingExplosionGenericSelfd-uw"
            LuaKey.String "sightdistance", LuaValue.Number 515.0
            ...
            LuaKey.String "featuredefs", LuaValue.Table [
                    LuaKey.String "dead", LuaValue.Table [
                            LuaKey.String "blocking", LuaValue.Bool false
                            LuaKey.String "category", LuaValue.String "corpses"
                            LuaKey.String "collisionvolumeoffsets", LuaValue.String "0.0 -1.56127929678e-05 -0.0"
                            LuaKey.String "collisionvolumescales", LuaValue.String "31.3499755859 42.5373687744 28.2463684082"
                            LuaKey.String "collisionvolumetype", LuaValue.String "Box"
                            LuaKey.String "damage", LuaValue.Number 30.0
                            LuaKey.String "footprintx", LuaValue.Number 2.0
                            LuaKey.String "footprintz", LuaValue.Number 2.0
                            LuaKey.String "height", LuaValue.Number 4.0
                            LuaKey.String "metal", LuaValue.Number 13.0
                            LuaKey.String "object", LuaValue.String "Units/armsonar_dead.s3o"
                            LuaKey.String "reclaimable", LuaValue.Bool true
                        ]
                ]
            LuaKey.String "sounds", LuaValue.Table [
                    LuaKey.String "activate", LuaValue.String "sonar1"
                    LuaKey.String "canceldestruct", LuaValue.String "cancel2"
                    LuaKey.String "deactivate", LuaValue.String "sonarde1"
                    LuaKey.String "underattack", LuaValue.String "warning1"
                    LuaKey.String "count", LuaValue.Table [
                            LuaKey.Int 1, LuaValue.String "count6"
                            LuaKey.Int 2, LuaValue.String "count5"
