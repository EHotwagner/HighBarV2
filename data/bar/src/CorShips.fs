...
module CorShips =
    ...
    let correcl : Correcl =
        { name = "correcl"
          subfolder = "CorShips"
          printableName = Some "Death Cavalry"
