// Auto-generated BAR unit data: CorGantry (unified)
    ...
    let corkorg : Corkorg =
        { name = "corkorg"
          ...
          weapons = [
                ...
                { name = "corkorg_laser"
                  displayName = "Experimental g2g Eradicator Heat Ray"
                  weaponType = Some "BeamLaser"
                  damage = Map.ofList [
                      "commanders", 1200.0
                      "default", 5500.0
