// Auto-generated BAR unit data: CorShips/T2
...
module CorShips_T2 =
    ...
    let corbats : UnitDef =
        { name = "corbats"
          ...
          weapons = Some [
              { name = "cor_bats"
                displayName = Some "BattleshipCannon"
                weaponType = Some "Cannon"
                damage = Map.ofList [
                    "default", 450.0
                    "vtol", 65.0
    ...
    let corfship : UnitDef =
        { name = "corfship"
          ...
          weapons = Some [
              { name = "dmaw"
                displayName = Some "Heavy long range AoE flamethrower"
    ...
    let coronager : UnitDef =
        { name = "coronager"
          ...
          weapons = Some [
              { name = "stoa_missile"
                displayName = Some "Medium long-range s2g missile launcher"
                weaponType = Some "StarburstLauncher"
                damage = Map.ofList [
                    "default", 360.0
                    "ship", 200.0
    ...
    let corprince : UnitDef =
        { name = "corprince"
          ...
          weapons = Some [
              { name = "heavyplasma"
                displayName = Some "Heavy Long-Range Plasma Bombardment Cannon"
                weaponType = Some "Cannon"
                damage = Map.ofList [
                    "default", 2000.0
                    "shields", 1000.0
              ...
              { name = "navalplasma"
                displayName = Some "Long-Range Plasma Bombardment Cannons"
                weaponType = Some "Cannon"
                damage = Map.ofList [
                    "default", 1000.0
                    "shields", 500.0
              ...
              { name = "mobileflak"
                displayName = Some "Anti-Air Flak Cannons"
                weaponType = Some "Cannon"
                damage = Map.ofList [
                    "vtol", 200.0
                ]
    ...
    let all : (string * UnitDef) list =
        [
            "coracsub", coracsub
            "corantiship", corantiship
            "corarch", corarch
            "corbats", corbats
            "corblackhy", corblackhy
            "corcarry", corcarry
            "corcrus", corcrus
            "cordesolator", cordesolator
            "cordronecarry", cordronecarry
            "corfship", corfship
            "corhacs", corhacs
            "cormls", cormls
            "cormship", cormship
            "coronager", coronager
            "corprince", corprince
            "corsacvsub", corsacvsub
            "corsentinel", corsentinel
            "corshark", corshark
            "corsjam", corsjam
            "corssub", corssub
            "cortdrone", cortdrone
