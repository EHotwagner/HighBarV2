...
module CorShips_T2 =
    ...
    let corarch : Corarch =
        { name = "corarch"
          subfolder = "CorShips/T2"
          printableName = Some "Arrow Storm"
    ...
    let corblackhy : Corblackhy =
        { name = "corblackhy"
          subfolder = "CorShips/T2"
          printableName = Some "Black Hydra"
    ...
    let corprince : Corprince =
        { name = "corprince"
          subfolder = "CorShips/T2"
          printableName = Some "Black Prince"
