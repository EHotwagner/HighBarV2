// Auto-generated BAR unit data: CorAircraft/T2 (unified)
...
module CorAircraft_T2 =
    ...
    let corape : Corape =
        { name = "corape"
          ...
          weapons = [
                { name = "vtol_rocket"
                  displayName = "Heavy a2g shrapnel rockets"
    ...
    let corcrwh : Corcrwh =
        { name = "corcrwh"
          ...
          weapons = [
                { name = "dragonmawh"
                  displayName = "Dragon's Maw: heavy medium range AoE flamethrower"
    ...
    let corhurc : Corhurc =
        { name = "corhurc"
          ...
          weapons = [
                { name = "coradvbomb"
                  displayName = "Heavy a2g incinerating warheads"
    ...
    let cortitan : Cortitan =
        { name = "cortitan"
          ...
          weapons = [
                { name = "heavy_torpedo"
                  displayName = "Heavy homing torpedo launcher"
        ...
        { name = "corvamp"
          ...
          weapons = [
                { name = "corvtol_advmissile"
                  displayName = "Guided a2a/a2g missile launcher"
                  weaponType = Some "MissileLauncher"
                  damage = Map.ofList [
                      "commanders", 8.0
                      "default", 24.0
