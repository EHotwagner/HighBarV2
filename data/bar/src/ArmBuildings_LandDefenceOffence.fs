// Auto-generated BAR unit data: ArmBuildings/LandDefenceOffence (unified)
...
module ArmBuildings_LandDefenceOffence =
    ...
    let armamb : Armamb =
        { name = "armamb"
          ...
          footprintX = 4.0
          footprintZ = 4.0
          objectName = Some "Units/ARMAMB.s3o"
          buildPic = Some "ARMAMB.DDS"
          script = Some "Units/ARMAMB.cob"
          corpse = Some "DEAD"
          ...
          weapons = [
                { name = "armamb_gun"
                  displayName = "Pop-up heavy  long range g2g plasma cannon"
                ...
                { name = "armamb_gun_high"
                  displayName = "Pop-up heavy  long range g2g plasna cannon"
                  weaponType = Some "Cannon"
                  damage = Map.ofList [
                      "default", 350.0
                      "subs", 150.0
    ...
    let armamd : Armamd =
        { name = "armamd"
          ...
          footprintX = 4.0
          footprintZ = 4.0
          objectName = Some "Units/ARMAMD.s3o"
          buildPic = Some "ARMAMD.DDS"
          script = Some "Units/ARMAMD.cob"
          corpse = Some "DEAD"
    ...
    let armanni : Armanni =
        { name = "armanni"
          ...
          footprintX = 4.0
          footprintZ = 4.0
          objectName = Some "Units/ARMANNI.s3o"
          buildPic = Some "ARMANNI.DDS"
          ...
          collisionVolumeScales = Some "54 81 54"
          collisionVolumeType = Some "BoxY"
          seismicSignature = Some 0.0
          category = None
    ...
    let armbeamer : Armbeamer =
        { name = "armbeamer"
          ...
          footprintX = 2.0
          footprintZ = 2.0
          objectName = Some "Units/ARMBEAMER.s3o"
          buildPic = Some "armbeamer.DDS"
          script = Some "Units/armbeamer.cob"
          corpse = Some "DEAD"
          ...
          weapons = [
                { name = "armbeamer_weapon"
                  displayName = "Anti-swarm constant wave g2g laser"
                  weaponType = Some "BeamLaser"
                  damage = Map.ofList [
                      "commanders", 40.0
                      "default", 26.6
    ...
    let armbrtha : Armbrtha =
        { name = "armbrtha"
          ...
          footprintX = 4.0
          footprintZ = 4.0
          objectName = Some "Units/ARMBRTHA.s3o"
          buildPic = Some "ARMBRTHA.DDS"
          script = Some "Units/armbrtha.cob"
          corpse = Some "DEAD"
          explodeAs = Some "hugeBuildingExplosionGeneric"
          selfDestructAs = Some "hugeBuildingExplosionGenericSelfd"
    ...
    let armcir : Armcir =
        { name = "armcir"
          ...
          footprintX = 4.0
          footprintZ = 4.0
          objectName = Some "Units/ARMCIR.s3o"
          buildPic = Some "ARMCIR.DDS"
          script = Some "Units/ARMCIR.cob"
          corpse = Some "DEAD"
          explodeAs = Some "mediumBuildingExplosionGeneric"
          selfDestructAs = Some "mediumBuildingExplosionGenericSelfd"
          collisionVolumeOffsets = Some "0 0 0"
    ...
    let armclaw : Armclaw =
        { name = "armclaw"
          ...
          footprintX = 2.0
          footprintZ = 2.0
          objectName = Some "Units/ARMCLAW.s3o"
          buildPic = Some "ARMCLAW.DDS"
          script = Some "Units/ARMCLAW.cob"
          corpse = Some "DEAD"
          explodeAs = Some "smallBuildingexplosiongeneric"
    ...
    let armemp : Armemp =
        { name = "armemp"
          ...
          footprintX = 4.0
          footprintZ = 4.0
          objectName = Some "Units/ARMEMP.s3o"
          buildPic = Some "ARMEMP.DDS"
          script = Some "Units/ARMEMP.cob"
          corpse = Some "DEAD"
    ...
    let armferret : Armferret =
        { name = "armferret"
          ...
          footprintX = 3.0
          footprintZ = 3.0
          objectName = Some "Units/ARMFERRET.s3o"
          buildPic = Some "ARMFERRET.DDS"
          script = Some "Units/ARMFERRET.cob"
          corpse = Some "DEAD"
          explodeAs = Some "mediumBuildingexplosiongeneric"
          selfDestructAs = Some "mediumBuildingExplosionGenericSelfd"
          collisionVolumeOffsets = Some "0 0 0"
    ...
    let armflak : Armflak =
        { name = "armflak"
          ...
          footprintX = 3.0
          footprintZ = 3.0
          objectName = Some "Units/ARMFLAK.s3o"
          buildPic = Some "ARMFLAK.DDS"
          script = Some "Units/ARMFLAK.cob"
          corpse = Some "DEAD"
          explodeAs = Some "mediumBuildingexplosiongeneric"
          selfDestructAs = Some "mediumBuildingExplosionGenericSelfd"
          collisionVolumeOffsets = Some "0 -3 0"
          collisionVolumeScales = Some "36 55 36"
          collisionVolumeType = Some "CylY"
          seismicSignature = Some 0.0
          category = None
          yardMap = "ooooooooo"
    ...
    let armguard : Armguard =
        { name = "armguard"
          ...
          footprintX = 4.0
          footprintZ = 4.0
          objectName = Some "Units/ARMGUARD.s3o"
          buildPic = Some "ARMGUARD.DDS"
          script = Some "Units/ARMGUARD.cob"
          corpse = Some "DEAD"
          explodeAs = Some "mediumBuildingExplosionGeneric"
          selfDestructAs = Some "mediumBuildingExplosionGenericSelfd"
          collisionVolumeOffsets = Some "0 -5 0"
          collisionVolumeScales = Some "48 40 48"
          collisionVolumeType = Some "box"
          seismicSignature = Some 0.0
          category = None
          yardMap = "oooooooooooooooo"
          ...
          weapons = [
                { name = "plasma"
                  displayName = "Heavy g2g long range plasma cannon"
                  weaponType = Some "Cannon"
                  damage = Map.ofList [
                      "default", 300.0
                      "subs", 150.0
    ...
    let armhlt : Armhlt =
        { name = "armhlt"
          ...
          footprintX = 2.0
          footprintZ = 2.0
          objectName = Some "Units/ARMHLT.s3o"
          buildPic = Some "ARMHLT.DDS"
          script = Some "Units/ARMHLT.cob"
          corpse = Some "DEAD"
          explodeAs = Some "mediumBuildingExplosionGeneric"
          selfDestructAs = Some "mediumBuildingExplosionGenericSelfd"
          collisionVolumeOffsets = Some "0 11 0"
          collisionVolumeScales = Some "36 88 36"
          collisionVolumeType = Some "CylY"
          seismicSignature = Some 0.0
          category = None
          yardMap = "oooo"
          ...
          weapons = [
                { name = "arm_laserh1"
                  displayName = "Heavy g2g high energy laser"
                  weaponType = Some "BeamLaser"
                  damage = Map.ofList [
                      "commanders", 580.5
                      "default", 387.0
    ...
    let armjuno : Armjuno =
        { name = "armjuno"
          ...
          footprintX = 4.0
          footprintZ = 4.0
          objectName = Some "Units/ARMJUNO.s3o"
          buildPic = Some "ARMJUNO.DDS"
          script = Some "Units/ARMJUNO.cob"
          corpse = Some "DEAD"
          explodeAs = Some "largeBuildingexplosiongeneric"
          selfDestructAs = Some "largeBuildingExplosionGenericSelfd"
          collisionVolumeOffsets = Some "0 0 0"
    ...
    let armllt : Armllt =
        { name = "armllt"
          ...
          footprintX = 2.0
          footprintZ = 2.0
          objectName = Some "Units/ARMLLT.s3o"
          buildPic = Some "ARMLLT.DDS"
          script = Some "Units/ARMLLT.cob"
          corpse = Some "DEAD"
          explodeAs = Some "mediumBuildingExplosionGeneric"
          selfDestructAs = Some "mediumBuildingExplosionGenericSelfd"
          collisionVolumeOffsets = Some "0 -31 0"
          collisionVolumeScales = Some "32 77 32"
          collisionVolumeType = Some "CylY"
          seismicSignature = Some 0.0
          category = None
          yardMap = "oooo"
          ...
          weapons = [
                { name = "arm_lightlaser"
                  displayName = "Light g2g laser turret"
                  weaponType = Some "BeamLaser"
                  damage = Map.ofList [
                      "commanders", 112.5
                      "default", 75.0
    ...
    let armmercury : Armmercury =
        { name = "armmercury"
          ...
          footprintX = 4.0
          footprintZ = 4.0
          objectName = Some "Units/ARMMERCURY.s3o"
          buildPic = Some "ARMMERCURY.DDS"
          script = Some "Units/ARMMERCURY.cob"
          corpse = Some "DEAD"
          explodeAs = Some "largeBuildingExplosionGeneric"
          selfDestructAs = Some "largeBuildingExplosionGenericSelfd"
          ...
          weapons = [
                { name = "arm_advsam"
                  displayName = "Heavy long-range g2a guided missile launcher"
                  weaponType = Some "MissileLauncher"
                  damage = Map.ofList [
                      "vtol", 750.0
                  ]
    ...
    let armpb : Armpb =
        { name = "armpb"
          ...
          footprintX = 3.0
          footprintZ = 3.0
          objectName = Some "Units/ARMPB.s3o"
          buildPic = Some "ARMPB.DDS"
          script = Some "Units/ARMPB.cob"
          corpse = Some "DEAD"
          explodeAs = Some "smallBuildingExplosionGeneric"
          selfDestructAs = Some "smallBuildingExplosionGenericSelfd"
          collisionVolumeOffsets = None
          ...
          weapons = [
                { name = "armpb_weapon"
                  displayName = "Pop-up heavy g2g gauss cannon"
                  weaponType = Some "Cannon"
                  damage = Map.ofList [
                      "default", 675.0
                      "hvyboats", 472.5
    ...
    let armrl : Armrl =
        { name = "armrl"
          ...
          footprintX = 3.0
          footprintZ = 3.0
          objectName = Some "Units/ARMRL.s3o"
          buildPic = Some "ARMRL.DDS"
          script = Some "Units/ARMRL.cob"
          corpse = Some "DEAD"
          explodeAs = Some "mediumBuildingExplosionGeneric"
          selfDestructAs = Some "mediumBuildingExplosionGenericSelfd"
          collisionVolumeOffsets = Some "0 0 0"
    ...
    let armshockwave : Armshockwave =
        { name = "armshockwave"
          ...
          footprintX = 4.0
          footprintZ = 4.0
          objectName = Some "Units/armshockwave.s3o"
          buildPic = Some "ARMSHOCKWAVE.DDS"
          script = Some "Units/armshockwave.cob"
          corpse = Some "DEAD"
    ...
    let armsilo : Armsilo =
        { name = "armsilo"
          ...
          footprintX = 7.0
          footprintZ = 7.0
          objectName = Some "Units/ARMSILO.s3o"
          buildPic = Some "ARMSILO.DDS"
          script = Some "Units/ARMSILO.cob"
          corpse = Some "DEAD"
          explodeAs = Some "nukeBuilding"
          selfDestructAs = Some "nukeBuildingSelfd"
          collisionVolumeOffsets = Some "-1 3 1"
    ...
    let armvulc : Armvulc =
        { name = "armvulc"
          ...
          footprintX = 8.0
          footprintZ = 8.0
          objectName = Some "Units/ARMVULC.s3o"
          buildPic = Some "ARMVULC.DDS"
          script = Some "Units/ARMVULC.cob"
          corpse = Some "DEAD"
          explodeAs = Some "customfusionexplo"
          selfDestructAs = Some "advancedFusionExplosionSelfd"
          collisionVolumeOffsets = Some "0 0 -45"
          collisionVolumeScales = Some "90 145 90"
          collisionVolumeType = Some "CylY"
          seismicSignature = Some 0.0
          category = None
