...
module other_raptors_Assault_Advanced_AllTerrain =
    ...
    let raptor_allterrain_assault_basic_t4_v1 =
        LuaValue.Table [
            ...
            LuaKey.String "buildpic", LuaValue.String "raptors/raptorapexallterrainassault.DDS"
            ...
            LuaKey.String "collisionvolumescales", LuaValue.String "37 55 90"
            ...
            LuaKey.String "objectname", LuaValue.String "Raptors/raptorapexallterrainassault.s3o"
            LuaKey.String "script", LuaValue.String "Raptors/raptorapexallterraina.cob"
            ...
            LuaKey.String "unitname", LuaValue.String "raptor_allterrain_assault_basic_t4_v1"
            LuaKey.String "upright", LuaValue.Bool false
            LuaKey.String "waterline", LuaValue.Number 34.0
    ...
    let raptor_allterrain_assault_basic_t4_v2 =
        LuaValue.Table [
            LuaKey.String "maxacc", LuaValue.Number 0.414
            LuaKey.String "airsightdistance", LuaValue.Number 1800.0
            ...
            LuaKey.String "metalcost", LuaValue.Number 302.0
            LuaKey.String "builder", LuaValue.Bool false
            LuaKey.String "buildpic", LuaValue.String "raptors/raptorapexallterrainassaultb.DDS"
            LuaKey.String "buildtime", LuaValue.Number 30000.0
            LuaKey.String "canattack", LuaValue.Bool true
            LuaKey.String "canguard", LuaValue.Bool true
            LuaKey.String "canmove", LuaValue.Bool true
            ...
            LuaKey.String "noautofire", LuaValue.Bool false
            LuaKey.String "nochasecategory", LuaValue.String "VTOL"
            LuaKey.String "objectname", LuaValue.String "Raptors/raptorapexallterrainassaultb.s3o"
            LuaKey.String "script", LuaValue.String "Raptors/raptorapexallterraina.cob"
            LuaKey.String "seismicsignature", LuaValue.Number 0.0
            LuaKey.String "selfdestructas", LuaValue.String "BIGBUG_DEATH"
            LuaKey.String "side", LuaValue.String "THUNDERBIRDS"
            ...
            LuaKey.String "turninplaceanglelimit", LuaValue.Number 90.0
            LuaKey.String "turnrate", LuaValue.Number 920.0
            LuaKey.String "unitname", LuaValue.String "raptor_allterrain_assault_basic_t4_v2"
            LuaKey.String "upright", LuaValue.Bool false
            LuaKey.String "waterline", LuaValue.Number 34.0
            LuaKey.String "workertime", LuaValue.Number 0.0
            LuaKey.String "customparams", LuaValue.Table [
