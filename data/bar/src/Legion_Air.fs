...
module Legion_Air =
    ...
    let legdrone : Legdrone =
        { name = "legdrone"
          subfolder = "Legion/Air"
          printableName = Some "Legion Drone"
