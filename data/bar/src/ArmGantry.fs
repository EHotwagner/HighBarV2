// Auto-generated BAR unit data: ArmGantry (unified)
...
module ArmGantry =
    ...
    let armbanth : Armbanth =
        { name = "armbanth"
          ...
          weapons = [
                { name = "armbantha_fire"
                  displayName = "Close-quarters impulsion blaster"
                ...
                { name = "tehlazerofdewm"
                  displayName = "High-energy long-range g2g/g2a lazor of DEEEEEEWWWWWWMMMMMM"
                ...
                { name = "bantha_rocket"
                  displayName = "Heavy g2g/g2a guided starburst missile launcher"
    ...
    let armlun : Armlun =
        { name = "armlun"
          ...
          weapons = [
                { name = "cannon"
                  displayName = "Heavy ballistic underwater cannon"
                  weaponType = Some "Cannon"
                  damage = Map.ofList [
                      "default", 370.0
                      "subs", 370.0
    ...
    let armmar : Armmar =
        { name = "armmar"
          ...
          weapons = [
                { name = "armmech_cannon"
                  displayName = "Double close-quarters gauss cannon"
                  weaponType = Some "Cannon"
                  damage = Map.ofList [
                      "default", 235.0
                      "vtol", 60.0
    ...
    let armthor : Armthor =
        { name = "armthor"
          ...
          weapons = [
                { name = "thunder"
                  displayName = "Heavy Lighting Cannon"
                ...
                { name = "emp"
                  displayName = "Long Range EMP laser"
                  weaponType = Some "BeamLaser"
                  damage = Map.ofList [
                      "default", 300.0
                  ]
