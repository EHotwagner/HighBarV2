// Auto-generated BAR unit data: Legion/Ships/T2 (unified)
...
module Legion_Ships_T2 =
        ...
        { name = "leganavyaaship"
          ...
          weapons = [
                ...
                { name = "light_antiair_missile"
                  displayName = "Advanced Anti-Air Salvo Missile Launcher"
        ...
        { name = "leganavyantinukecarrier"
          ...
          weapons = [
                { name = "leg_drone_controller"
                  displayName = "Multi-Drone Control Matrix"
                  weaponType = Some "Cannon"
                  damage = Map.ofList [
                      "default", 0.0
                  ]
        ...
        { name = "leganavyartyship"
          ...
          weapons = [
                { name = "leg_mobile_cluster_lrpc_cannon"
                  displayName = "Dual Quad-Barrelled Long-Range Cluster Plasma Cannon"
                  weaponType = Some "Cannon"
                  damage = Map.ofList [
                      "default", 350.0
                      "subs", 50.0
                ...
                { name = "leg_mobile_cluster_plasma"
                  displayName = "Heavy Artillery Cluster Plasma Cannon"
                  weaponType = Some "Cannon"
                  damage = Map.ofList [
                      "default", 250.0
                      "lboats", 250.0
    ...
    let leganavybattlesub : Leganavybattlesub =
        { name = "leganavybattlesub"
          ...
          weapons = [
                { name = "torpedo_swarm"
                  displayName = "Packhound Torpedo System"
        ...
        { name = "leganavyflagship"
          ...
          weapons = [
                ...
                { name = "leg_experimental_heatray"
                  displayName = "Dual Experimental Thermal Ordnance Generators"
                ...
                { name = "leg_experimental_railgun"
                  displayName = "Dual Naval-Series Rail Accelerators"
                  weaponType = Some "LaserCannon"
                  damage = Map.ofList [
                      "commanders", 300.0
                      "default", 800.0
    ...
    let leganavyheavysub : Leganavyheavysub =
        { name = "leganavyheavysub"
          ...
          weapons = [
                { name = "torpedo_large"
                  displayName = "Long-Range Heavy Torpedo"
                  weaponType = Some "TorpedoLauncher"
                  damage = Map.ofList [
                      "commanders", 750.0
                      "default", 1650.0
        ...
        { name = "leganavymissileship"
          ...
          weapons = [
                { name = "leg_salvo_vertical_rocket"
                  displayName = "Heavy Long-Range Vertical Salvo Rocket Launcher"
                  weaponType = Some "Cannon"
                  damage = Map.ofList [
                      "commanders", 300.0
                      "default", 450.0
                ...
                { name = "leg_light_aa_missile"
                  displayName = "Anti-Air Salvo Missile Launcher"
                  weaponType = Some "MissileLauncher"
                  damage = Map.ofList [
                      "vtol", 20.0
                  ]
