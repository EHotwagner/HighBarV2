// Auto-generated BAR unit data: other/raptors/Assault/AllTerrain
...
module other_raptors_Assault_AllTerrain =
    ...
    let raptor_allterrain_assault_basic_t2_v1 =
        LuaValue.Table [
            ...
            LuaKey.String "buildpic", LuaValue.String "raptors/raptorallterraina1.DDS"
            ...
            LuaKey.String "objectname", LuaValue.String "Raptors/raptorallterraina1.s3o"
            ...
            LuaKey.String "unitname", LuaValue.String "raptor_allterrain_assault_basic_t2_v1"
            LuaKey.String "upright", LuaValue.Bool false
            LuaKey.String "waterline", LuaValue.Number 23.0
    ...
    let raptor_allterrain_assault_basic_t2_v2 =
        LuaValue.Table [
            LuaKey.String "maxacc", LuaValue.Number 0.299
            LuaKey.String "airsightdistance", LuaValue.Number 650.0
            LuaKey.String "maxdec", LuaValue.Number 0.46
            LuaKey.String "energycost", LuaValue.Number 3520.0
            LuaKey.String "metalcost", LuaValue.Number 152.0
            LuaKey.String "builder", LuaValue.Bool false
            LuaKey.String "buildpic", LuaValue.String "raptors/raptorallterraina1b.DDS"
            LuaKey.String "buildtime", LuaValue.Number 8250.0
            LuaKey.String "canattack", LuaValue.Bool true
            LuaKey.String "canguard", LuaValue.Bool true
            LuaKey.String "canmove", LuaValue.Bool true
            LuaKey.String "canpatrol", LuaValue.Bool true
            ...
            LuaKey.String "noautofire", LuaValue.Bool false
            LuaKey.String "nochasecategory", LuaValue.String "VTOL"
            LuaKey.String "objectname", LuaValue.String "Raptors/raptorallterraina1b.s3o"
            LuaKey.String "script", LuaValue.String "Raptors/raptorallterraina1.cob"
            LuaKey.String "seismicsignature", LuaValue.Number 0.0
            LuaKey.String "selfdestructas", LuaValue.String "BIGBUG_DEATH"
            LuaKey.String "side", LuaValue.String "THUNDERBIRDS"
            ...
            LuaKey.String "turninplaceanglelimit", LuaValue.Number 90.0
            LuaKey.String "turnrate", LuaValue.Number 920.0
            LuaKey.String "unitname", LuaValue.String "raptor_allterrain_assault_basic_t2_v2"
            LuaKey.String "upright", LuaValue.Bool false
            LuaKey.String "waterline", LuaValue.Number 23.0
            LuaKey.String "workertime", LuaValue.Number 0.0
            LuaKey.String "customparams", LuaValue.Table [
    ...
    let raptor_allterrain_assault_basic_t2_v3 =
        LuaValue.Table [
            LuaKey.String "maxacc", LuaValue.Number 0.414
            LuaKey.String "airsightdistance", LuaValue.Number 650.0
            LuaKey.String "maxdec", LuaValue.Number 0.46
            ...
            LuaKey.String "metalcost", LuaValue.Number 152.0
            LuaKey.String "builder", LuaValue.Bool false
            LuaKey.String "buildpic", LuaValue.String "raptors/raptorallterraina1c.DDS"
            ...
            LuaKey.String "noautofire", LuaValue.Bool false
            LuaKey.String "nochasecategory", LuaValue.String "VTOL"
            LuaKey.String "objectname", LuaValue.String "Raptors/raptorallterraina1c.s3o"
            LuaKey.String "script", LuaValue.String "Raptors/raptorallterraina1.cob"
            LuaKey.String "seismicsignature", LuaValue.Number 0.0
            LuaKey.String "selfdestructas", LuaValue.String "BIGBUG_DEATH"
            LuaKey.String "side", LuaValue.String "THUNDERBIRDS"
            ...
            LuaKey.String "turninplaceanglelimit", LuaValue.Number 90.0
            LuaKey.String "turnrate", LuaValue.Number 920.0
            LuaKey.String "unitname", LuaValue.String "raptor_allterrain_assault_basic_t2_v3"
            LuaKey.String "upright", LuaValue.Bool false
            LuaKey.String "waterline", LuaValue.Number 23.0
            LuaKey.String "workertime", LuaValue.Number 0.0
            LuaKey.String "customparams", LuaValue.Table [
    ...
    let all : (string * LuaValue) list =
        [
            "raptor_allterrain_assault_basic_t2_v1", raptor_allterrain_assault_basic_t2_v1
            "raptor_allterrain_assault_basic_t2_v2", raptor_allterrain_assault_basic_t2_v2
            "raptor_allterrain_assault_basic_t2_v3", raptor_allterrain_assault_basic_t2_v3
        ]
