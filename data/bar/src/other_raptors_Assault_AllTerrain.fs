// Auto-generated BAR unit data: other/raptors/Assault/AllTerrain (unified)
namespace BarData.Units

open BarData

module other_raptors_Assault_AllTerrain =

    type Raptor_allterrain_assault_basic_t2_v1 =
        { name: string
          subfolder: string
    ...
    let raptor_allterrain_assault_basic_t2_v1 : Raptor_allterrain_assault_basic_t2_v1 =
        { name = "raptor_allterrain_assault_basic_t2_v1"
          subfolder = "other/raptors/Assault/AllTerrain"
          printableName = Some "All-Terrain Brawler"
          ...
          footprintX = 3.0
          footprintZ = 3.0
          objectName = Some "Raptors/raptorallterraina1.s3o"
          buildPic = Some "raptors/raptorallterraina1.DDS"
    ...
    let raptor_allterrain_assault_basic_t2_v1Def : UnitDef =
        { name = "raptor_allterrain_assault_basic_t2_v1"
          subfolder = "other/raptors/Assault/AllTerrain"
          printableName = Some "All-Terrain Brawler"
          metalCost = ValueOrExpr.Concrete 152.0
    ...
    let raptor_allterrain_assault_basic_t2_v1ToFlat (def: UnitDef) : Raptor_allterrain_assault_basic_t2_v1 =
        { name = def.name
    ...
    let raptor_allterrain_assault_basic_t2_v1ToUnitDef (flat: Raptor_allterrain_assault_basic_t2_v1) : UnitDef =
        { name = flat.name
    ...
    type Raptor_allterrain_assault_basic_t2_v2 =
        { name: string
          subfolder: string
          printableName: string option
          metalCost: ValueOrExpr<float>
    ...
    let raptor_allterrain_assault_basic_t2_v2 : Raptor_allterrain_assault_basic_t2_v2 =
        { name = "raptor_allterrain_assault_basic_t2_v2"
          ...
          footprintX = 3.0
          footprintZ = 3.0
          objectName = Some "Raptors/raptorallterraina1b.s3o"
          buildPic = Some "raptors/raptorallterraina1b.DDS"
          script = Some "Raptors/raptorallterraina1.cob"
          corpse = None
          explodeAs = Some "BIGBUG_DEATH"
          selfDestructAs = Some "BIGBUG_DEATH"
    ...
    let raptor_allterrain_assault_basic_t2_v2Def : UnitDef =
        { name = "raptor_allterrain_assault_basic_t2_v2"
          subfolder = "other/raptors/Assault/AllTerrain"
          printableName = Some "All-Terrain Brawler"
          metalCost = ValueOrExpr.Concrete 152.0
    ...
    let raptor_allterrain_assault_basic_t2_v2ToFlat (def: UnitDef) : Raptor_allterrain_assault_basic_t2_v2 =
        { name = def.name
          subfolder = def.subfolder
          printableName = def.printableName
          metalCost = def.metalCost
    ...
    let raptor_allterrain_assault_basic_t2_v2ToUnitDef (flat: Raptor_allterrain_assault_basic_t2_v2) : UnitDef =
        { name = flat.name
          subfolder = flat.subfolder
          printableName = flat.printableName
          metalCost = flat.metalCost
    ...
    type Raptor_allterrain_assault_basic_t2_v3 =
        { name: string
          subfolder: string
          printableName: string option
          metalCost: ValueOrExpr<float>
    ...
    let raptor_allterrain_assault_basic_t2_v3 : Raptor_allterrain_assault_basic_t2_v3 =
        { name = "raptor_allterrain_assault_basic_t2_v3"
          ...
          footprintX = 3.0
          footprintZ = 3.0
          objectName = Some "Raptors/raptorallterraina1c.s3o"
          buildPic = Some "raptors/raptorallterraina1c.DDS"
          script = Some "Raptors/raptorallterraina1.cob"
          corpse = None
          explodeAs = Some "BIGBUG_DEATH"
          selfDestructAs = Some "BIGBUG_DEATH"
    ...
    let raptor_allterrain_assault_basic_t2_v3Def : UnitDef =
        { name = "raptor_allterrain_assault_basic_t2_v3"
          subfolder = "other/raptors/Assault/AllTerrain"
          printableName = Some "All-Terrain Brawler"
          metalCost = ValueOrExpr.Concrete 152.0
    ...
    let raptor_allterrain_assault_basic_t2_v3ToFlat (def: UnitDef) : Raptor_allterrain_assault_basic_t2_v3 =
        { name = def.name
          subfolder = def.subfolder
          printableName = def.printableName
          metalCost = def.metalCost
    ...
    let raptor_allterrain_assault_basic_t2_v3ToUnitDef (flat: Raptor_allterrain_assault_basic_t2_v3) : UnitDef =
        { name = flat.name
          subfolder = flat.subfolder
          printableName = flat.printableName
          metalCost = flat.metalCost
