...
module other_raptors_Swarmer =
    ...
    let raptor_land_swarmer_basic_t1_v1 : UnitDef =
    ...
    let raptor_land_swarmer_basic_t2_v1 : UnitDef =
    ...
    let raptor_land_swarmer_basic_t2_v2 : UnitDef =
    ...
    let raptor_land_swarmer_basic_t2_v3 : UnitDef =
    ...
    let raptor_land_swarmer_basic_t2_v4 : UnitDef =
    ...
    let raptor_land_swarmer_basic_t3_v1 : UnitDef =
    ...
    let raptor_land_swarmer_basic_t3_v2 : UnitDef =
    ...
    let raptor_land_swarmer_basic_t3_v3 : UnitDef =
