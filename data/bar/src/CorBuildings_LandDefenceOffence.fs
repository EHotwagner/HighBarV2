...
module CorBuildings_LandDefenceOffence =
    ...
    let cormaw : Cormaw =
        { name = "cormaw"
          subfolder = "CorBuildings/LandDefenceOffence"
          printableName = Some "Dragon's Maw"
    ...
    let cormexp : Cormexp =
        { name = "cormexp"
          subfolder = "CorBuildings/LandDefenceOffence"
          printableName = Some "Advanced Exploiter"
