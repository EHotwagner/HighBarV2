...
module Scavengers_Air =
    ...
    let armthundt4 : UnitDef =
        { name = "armthundt4"
          ...
          weapons = Some [
              { name = "armbomb"
                displayName = Some "Ultra Heavy Bombs"
                weaponType = Some "AircraftBomb"
                damage = Map.ofList [
                    "commanders", 150.0
                    "default", 900.0
    ...
    let corcrw : UnitDef =
        { name = "corcrw"
          ...
          weapons = Some [
              { name = "krowlaser2"
                displayName = Some "High energy a2g laser"
        ...
        { name = "corcrwt4"
          ...
          weapons = Some [
              ...
              { name = "edragon_missile"
                displayName = Some "Advanced antiair rapid missile launcher"
                weaponType = Some "MissileLauncher"
                damage = Map.ofList [
                    "bombers", 400.0
                    "fighters", 400.0
              ...
              { name = "krowbosslaser"
                displayName = Some "Ultra HighEnergyLaser"
                weaponType = Some "BeamLaser"
                damage = Map.ofList [
                    "commanders", 200.0
                    "default", 2000.0
