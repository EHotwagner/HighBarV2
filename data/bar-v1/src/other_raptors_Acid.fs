...
module other_raptors_Acid =
    ...
    let raptor_air_bomber_acid_t2_v1 : UnitDef =
    ...
    let raptor_allterrain_arty_acid_t2_v1 : UnitDef =
    ...
    let raptor_allterrain_arty_acid_t4_v1 : UnitDef =
    ...
    let raptor_allterrain_assault_acid_t2_v1 : UnitDef =
    ...
    let raptor_allterrain_swarmer_acid_t2_v1 : UnitDef =
    ...
    let raptor_land_assault_acid_t2_v1 : UnitDef =
    ...
    let raptor_land_swarmer_acids_t2_v1 : UnitDef =
