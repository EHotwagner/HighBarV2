# HighBar V2 Documentation

Complete documentation for the HighBar V2 native proxy bridge for Beyond All Reason AI development.

## Guides

- [Getting Started](getting-started.md) — Prerequisites, building, installation, first game
- [Architecture Overview](architecture.md) — System design, components, data flow, design principles
...
- [Tools](tools.md) — echo-ai, reference-ai, game-runner, replay, generate-bar-data

## Quality

- [Testing](testing.md) — Multi-tier test strategy, all test suites documented
- [Known Issues](known-issues.md) — TODOs, limitations, workarounds
